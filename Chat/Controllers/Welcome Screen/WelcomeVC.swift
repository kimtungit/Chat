...
// Live Chat
//
//  Created by Kimtungit on 1/20/20.
...
class WelcomeVC: UIViewController {
    ...
    // ---------------------------------------------------------------------------------------------------------------------------------------------------- //
    // WelcomeVC: INFO ABOUT Live Chat. This is the first view that user is going to see once he/she launches the app. (If it is her/his first time using this app.)
    
    let welcomePages = [
        WelcomePage(imageName: "Logo-Light", topicText: "Live Chat", descriptionText: "The messaging app."),
