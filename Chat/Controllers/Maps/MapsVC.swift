...
// Live Chat
//
//  Created by Kimtungit on 1/8/20.
...
class MapsVC: UIViewController, UIGestureRecognizerDelegate{
    ...
    private func deniedAlertController(){
        let alertController = UIAlertController(title: "Error", message: "To be able to see the map you need to change your location settings. To do this, go to Settings/Privacy/Location Services/Live Chat/ and allow location access. ", preferredStyle: .alert)
